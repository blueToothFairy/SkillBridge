...
exports.runAcceptanceRemindersJob = runAcceptanceRemindersJob;
const prisma_1 = require("../config/prisma");
const client_1 = require("@prisma/client");
const logger_1 = require("./logger");
async function runAcceptanceRemindersJob() {
    const now = new Date();
    const summary = {
        remindersChecked: 0,
    ...
    try {
        const dueReminders = await prisma_1.prisma.acceptanceReminder.findMany({
            where: {
                triggeredAt: null,
                scheduledAt: { lte: now },
            },
        ...
        logger_1.logger.error(`Error in runAcceptanceRemindersJob: ${error.message}`);
